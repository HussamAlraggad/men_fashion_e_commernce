...
import type TryOn from '../../src/modules/try-on'
import type Measurements from '../../src/modules/measurements'
...
declare module '@medusajs/framework/types' {
  interface ModuleImplementations {
    ...
    'try_on': InstanceType<(typeof TryOn)['service']>,
    'measurements': InstanceType<(typeof Measurements)['service']>
  }
}